...
const DthScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.electricityTitle}>Select your DTH/cable provi...</Text>
      ...
      <View style={styles.suggestedSection}>
        ...
        >
          <View style={styles.tataContainer}>
            <Image
              source={{ uri: 'https://play-lh.googleusercontent.com/PTLQRc7a8vRjs8fmM7hRI36s7gGYalxIFd80xZDvYkIl91d709fcl4-UH9vZbxWDGG8' }}
              style={styles.tataImage}
            />
            <Text style={styles.tataText}>Tata play DTH (formerly TATA Sky)</Text>
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.operator}>
            ...
            />
            <Text style={styles.airtelText}>Airtel Digital TV</Text>
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.operator}>
            <Image
              source={{ uri: 'https://play-lh.googleusercontent.com/Tuz46h20-Wv198GpnGmiBp7iNfgTsqG5muEw0ASwlgJC0j8FH015p58zHsFIHtJPs7w' }}
              style={styles.d2hIcon}
            />
            <Text style={styles.d2hText}>D2H</Text>
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.operator}>
            <Image
              source={{ uri: 'https://play-lh.googleusercontent.com/bXnynz5j5KrS6akl84ZjtREia3vjJifDbXpFWUdosD_QWWAdBOn9ee64FwfUqAPGdqk' }}
              style={styles.sunIcon}
            />
            <Text style={styles.sunText}>Sun Direct</Text>
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.operator}>
            <Image
              source={{ uri: 'https://play-lh.googleusercontent.com/kldC0CzbkHZiYsAgN-Ox-YJjxeaM3X3Ti9u6WUNHii5_L54V8Uk2nK6F59AuRZ3C8T8' }}
              style={styles.dishIcon}
            />
            <Text style={styles.dishText}>Dish TV</Text>
          </View>
        </TouchableOpacity>
      </View>
